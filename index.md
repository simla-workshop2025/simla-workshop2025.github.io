...
| 15:45	| 6:45	| Invited Talk	| [Salah Ghamizi](https://wwwen.uni.lu/snt/people/salah_ghamizi)	|	Speaker Name: [Prof. Masashi Sugiyama](http://www.ms.k.u-tokyo.ac.jp/sugi/index.html) <br> <br> Affiliation: [RIKEN Center for Advanced Intelligence Project](https://aip.riken.jp/?lang=en)  <br> <br> Title: "Towards Trustworthy Machine Learning from Weakly Supervised, Noisy, and Biased Data" |
| 16:45 | 7:45	| Break	|	|	|
| 17:00	| 8:00	|	Paper (30 min each) | [Ezekiel Soremekun](https://ezekiel-soremekun.github.io/)	| (1) Aldin Vehabovic, Hadi Zanddizari, Farooq Shaikh, Nasir Ghani, Morteza Safaei Pour, Elias Bou Harb and Jorge Crichigno. Federated Learning Approach for Distributed Ransomware Analysis <br> <br> (2) Mohammed M. Alani, Atefeh Mashatan and Ali Miri. Forensic Identification of Android Trojans Using Stacked Ensemble of Deep Neural Networks <br> <br> (3) Haibo Zhang, Zhihua Yao and Kouichi Sakurai. Eliminating Adversarial Perturbations Using Image-to-Image Translation Method |
